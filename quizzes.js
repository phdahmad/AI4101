...
const QUIZ_BANK = {
  ...
  1: [
    ...
    },
    {
      ...
      correct: 1,
      explanation: "An agent perceives its environment and acts upon it. The thermostat perceives the temperature and acts by switching the cooling. The other options hold data but never act on anything. Note that being an agent is not the same as being an intelligent one: the thermostat follows one fixed rule and decides nothing."
    }
  ],
  ...
  2: [
    ...
    },
    {
      ...
      correct: 1,
      explanation: "PEAS is the standard four-line checklist for describing a task before building anything. Most failed projects fail in the P or the S, not in the algorithm."
    },
    {
